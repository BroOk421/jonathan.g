    ...
    <div className="w-full relative overflow-hidden mt-[-80px]">
      ...
      <div className="flex w-full h-[130vh] p-20 justify-center items-flex-start">
        ...
        {/* ------------------------------------------------------------------------------------------------------------------------ */}
          ...
          <div className="absolute flex w-[420px] h-auto top-[285px] left-[150px] rounded-md justify-center items-center bg-slate-100 p-[10px] opacity-0 max-xl:left-[-200px] max-sm:w-[370px] max-sm:left-[-185px] max-sm:top-[310px]" style={{opacity: fademid ? 1 : 0, transition: "opacity 1s ease"}}>
